...
const CloseCart = (props) => {
  ...
  const Cash = (props) =>{
    ...
    const [amount, setAmount] = useState(120.55)
    ...
    <div className="flex flex-row h-full w-full">
      <div className="flex flex-col h-fit w-fit border-2 justify-center">
          ...
          {<MoneyHand className="w-full h-24 mb-2 text-gray-500 dark:text-gray-400" />}
        ...
        <div className="mt-6">
          <div className="mt-2">
            ...
            <input type="text" ref={toPay} className="bg-gray-50 border border-gray-300 text-gray-900 text-xl font-semibold text-right rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-5/6 ml-4 p-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="150,73" value={amount.toFixed(2)} readOnly/>
          </div>
          <div className="mt-2">
            <label className=" ml-4 block mb-2 text-sm font-medium text-gray-900 dark:text-white"> Incasso</label>
            <input type="text" ref={given} className="bg-gray-50 border border-gray-300 text-gray-900 text-xl font-semibold text-right rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-5/6 ml-4 p-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  value={moneyTotal.toFixed(2)} readOnly/>
          </div>
          <div className="mt-2">
            <label className=" ml-4 block mb-2 text-sm font-medium text-gray-900 dark:text-white"> Scambio</label>
            <input type="text" id="change" className={`bg-gray-50 border border-gray-300 text-gray-900 text-xl font-semibold text-right rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-5/6 ml-4 p-3 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 ${change < 0 ? 'border-red-400' : 'border-green-400'}`} placeholder="150,73" value={change.toFixed(2)} readOnly/>
          </div>
        </div>
  ...
  const Card = (props)=> {
    return (
      ...
      <div className="w-[4rem] h-[4rem] mb-2 text-gray-500 dark:text-gray-400" aria-hidden="true">{props.icon}
  
      </div>
      <a href="#" onClick={()=>props.onClick(props.view)}>
          <h5 className="mb-2 text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{props.title}</h5>
      </a>
      <p className="mb-3 font-sm text-gray-500 dark:text-gray-400">{props.text}</p>
      {props.hyperlink &&
